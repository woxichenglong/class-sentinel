...
- P1 focused regression：50 个用例，失败 0、错误 0、跳过 0。
- JVM 全量：85 个测试类、436 个用例，失败 0、错误 0、跳过 0。
...
- 本轮 Debug APK：170,883,379 bytes；SHA-256 为 `427abad9efbf6c65412bd1096f9079ac0342d871c17be7784b059d36a7448619`。
